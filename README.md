...
**오! 당신은 역사퀴즈왕** — 하루 한 문제씩 올라오는 60초 한국사·세계사 퀴즈 쇼츠를 자동 생성·업로드하는 파이프라인.

## 영상 포맷 (60초)

| 구간 | 길이 | 내용 |
| --- | ---:| --- |
| 퀴즈 제시 | 5s | GPT-4o-mini 가 생성한 OX 또는 4지선다 문제 — 나래이션 + 큰 자막 |
| 카운트다운 | 5s | 5→4→3→2→1 화면 중앙 카운트 (매 초 밝기 펄스) |
| 정답 공개 | 5s | 화면 플래시 + "정답: O / X / N번" 크게 + 음성 |
| 해설 | 45s | 친근한 톤 낭독 해설 + 하단 자막 |
