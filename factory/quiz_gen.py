...
【난이도 기준】
- 초급: 중학교 1학년 교과서 기본 — 연도·인물·사건 1:1 매칭 수준.
  예: 세종대왕 즉위년(1418), 임진왜란 발발년도(1592)
- 중급: 중1~중2 심화 — 역사 흐름·인과관계 이해 필요.
  예: 고려 광종의 개혁 정책, 조선 세도정치 시작 인물
- 고급: 중3~고1 — 사건의 복합적 원인·사상적 배경 분석.
  예: 갑신정변 주도 인물들의 사상적 배경

【예시】
✅ 좋은 문제 (초급): "세종대왕은 몇 년에 즉위했는가? 1418년"
✅ 좋은 문제 (중급): "무신정변을 일으킨 인물은? 정중부"
✅ 좋은 문제 (고급): "갑신정변 주도 세력의 사상적 배경은? 개화사상"
❌ 나쁜 문제: "세종대왕의 키는? 170cm" (추정치, 불확실)
❌ 나쁜 문제: "한국의 수도는? 서울" (너무 쉬운 상식)
