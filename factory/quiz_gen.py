...
# 12s TTS 낭독 (speed 1.15) — 경험적 4.25 char/s → 안전 50자.
# 질문 segment 를 6s 로 늘렸으니 explanation 은 12s 로 줄였음 (총 24s 유지).
EXPLANATION_MIN = 30
EXPLANATION_MAX = 50
...
4. 왕 즉위 연도 질문 (전면 금지):
   ❌ "세종대왕은 몇 년에 즉위했나?" → 절대 금지
   ❌ "태조 이성계는 몇 년에 즉위했는가?" → 절대 금지
   ❌ "광종 즉위년은?" → 절대 금지
   → 왕의 즉위 연도는 단순 암기일 뿐 교육 가치 낮음. 대신 왕의
     구체 업적·정책·시대 맥락을 묻는 질문으로 전환.
