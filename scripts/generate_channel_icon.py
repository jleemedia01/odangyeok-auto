...
PROMPT = (
    ...
    "dressed as a king. He wears: "
    "(1) ON TOP OF THE HEAD — a BIG SHINY GOLD WESTERN-STYLE ROYAL CROWN with 5 tall pointed spikes, "
    "each spike tipped with a small round jewel (like a classic fairy-tale king crown, "
    "NOT a Korean gat, NOT a 익선관, NOT a Joseon black cap, NOT a headband — a proper 3D gold crown only), "
    "the crown should be the main visual eye-catcher, large and prominently visible above the head; "
    ...
    "NO Korean traditional hats (NO 익선관, NO gat, NO black cap, NO headband) — "
    "the headwear MUST be a Western-style fairy-tale gold crown with pointed spikes. "
    "\n\n"
